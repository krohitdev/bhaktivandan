        ...
        {showNavButtons && (
          <div className="flex gap-4">
            <div className="hidden lg:block">
              <Link
                to="/about"
                className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all inline-block ${isActive('/about')
            ...
            <Link
              to="/contact-us"
              className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all inline-block ${isActive('/contact-us')
                ? 'bg-orange-500 text-white'
                : 'bg-white text-stone-600 border border-stone-200 hover:text-orange-600'
                }`}
            >
