...
export const DEITIES: Deity[] = [
  {
    ...
    insights: [
      { title: 'महत्व (Significance)', content: 'भगवान गणेश को प्रथम पूज्य माना जाता है। किसी भी शुभ कार्य की शुरुआत उनसे होती है क्योंकि वे विघ्नहर्ता हैं।' },
      { title: 'लाभ (Benefits)', content: 'गणेश जी की उपासना से बुद्धि, सफलता और समृद्धि की प्राप्ति होती है। यह जीवन की बाधाओं को दूर करने में सहायक है।' }
    ]
  },
  {
    id: DeityId.HANUMAN,
    ...
    insights: [
      { title: 'महत्व (Significance)', content: 'हनुमान जी भगवान राम के परम भक्त हैं। वे निष्काम भक्ति, अपार शक्ति और साहस के प्रतीक हैं।' },
      { title: 'लाभ (Benefits)', content: 'हनुमान चालीसा का पाठ मानसिक शक्ति प्रदान करता है, भय को दूर करता है और साधक को शत्रुओं व नेगेटिविटी से बचाता है।' }
    ]
  },
  {
    id: DeityId.SHIVA,
    ...
    insights: [
      { title: 'महत्व (Significance)', content: 'भगवान शिव देवों के देव महादेव हैं। वे योग, ध्यान और शक्ति के मूल स्रोत हैं।' },
      { title: 'लाभ (Benefits)', content: 'शिव साधना से मन में शांति आती है, अहंकार का नाश होता है और साधक को जीवन-मृत्यु के चक्र से मुक्ति का मार्ग मिलता है।' }
    ]
  },
  {
    id: DeityId.DURGA,
    ...
    insights: [
      { title: 'महत्व (Significance)', content: 'माँ दुर्गा आदि शक्ति हैं। वे बुराई पर अच्छाई की विजय और नारी शक्ति का साक्षात् स्वरूप हैं।' },
      { title: 'लाभ (Benefits)', content: 'दुर्गा चालीसा के पाठ से आंतरिक शक्ति बढ़ती है, शत्रुओं का नाश होता है और घर में सुख-शांति का वास होता है।' }
    ]
  },
  {
    id: DeityId.KALI,
